...
const AgentUpdateProfile = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const res = await axios.post(`${baseUrl}/Agent/Update_Agent_Details`, {
        id: id,
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .post(`${baseUrl}/Agent/Get_Agent_Details`, {
        id: id,
      })
      .then((res) => {
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      ...
      axios
        .post(
          `${baseUrl}/Agent/Update_Agent_Profile_Pic`,
          formData
        )
        .then((res) => {
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 pt-4 pb-3">
              <h1 className="h1 text-center">Agent Profile</h1>
            </div>
          </div>
          <div className="row">
                  ...
                  >
                    <div className="row align-items-end">
                      ...
                      {errors.pancard && errors.pancard.type === "pattern" && (
                        <p className="error-message">Invalid PAN Card Number</p>
                      )}
                    </div>
                  </div>
                  <div
