...
export const SupplierUpdateProfile = () => {
  ...
  useEffect(() => {
    ...
    setValue("mobileno", data?.mobile_no);
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .post(`${baseUrl}/Agent/Get_Supplier_Detail`, {
        id: id,
      })
      .then((res) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const res = await axios.post(`${baseUrl}/Agent/Update_Supplier`, {
        id: id,
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      ...
      axios
        .post(
          `${baseUrl}/Agent/Update_supplier_Profile_Pic`,
          formData
        )
        .then((res) => {
                    ...
                    >
                            ...
                            >
                              ...
                              {state?.map((item) => {
                                return (
                                  <option
                                    selected={
                                      data?.state_id === item.id ? true : false
                                    }
                                    value={item.id}
                                  >
                                    {item.state}
                      ...
                      <div className="col-12">
                        ...
                        >
                          ...
                          <span
                            ...
                            style={{ color: "#4417A6" }}
                          >
                            {profileimg ? profileimg : "Upload Profile Picture"}
                          </span>
                        </label>
                        <input
                          id="profileupdate"
                      ...
                      >
                        ...
                        <div className="row align-items-end">
                          ...
                          {errors.aadharcard &&
                            errors.aadharcard.type === "pattern" && (
                              <p className="error-message">
