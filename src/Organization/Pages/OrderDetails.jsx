...
function OrgOrderDetails(props) {
 ...
 const FiledAgent ="/organization/field-agent"
            ...
            <Layout>
                <div className="">
                    ...
                    <div className="headprofile px-3 pt-3 border-0">
                        <NavLink to={"/organization/order-list"} className="text-dark">
                            <h5 className="m-0"><svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="px-3 my-2">
                            ...
                            <div className="col-lg-6">
                                <div className="orderCard add-order-detail-card form-border-bg p-3">
                                    ...
                                    <div className="d-flex  mb-0 align-items-start gp">
                                        <span className="Customerid">Shipping Address : </span>  <span className="lablename"> 45 Roker Terrace Latheronwheel
                                            KW5 8NW, Delhi, INDIA <br /> KW5 8NW, Delhi, INDIA</span>
                                    </div>
                        ...
                        <div className="row">
                            <div className="col-12">
                                ...
                                <Table {...tableProps} columns={columns} data={myData} FiledAgent={FiledAgent}  addAgent={addAgent} isFieldAgent={false}  isWarehouseAgent={true} editClick={editClick} isAddagent={false} isAddsupplier={false}   deleteClick={deleteClick} isDraft={false} isLive={false} isEdit={false} isDelete={false} isView={true}></Table>
                                </div>
