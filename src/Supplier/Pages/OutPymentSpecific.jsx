...
function OutPymentSpecific(props){
                ...
                <div className="headprofile px-3 pt-3 border-0">
                    <nav aria-label="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                         ...
                         <li class="active" aria-current="page">Outstanding Payments<img className='breadright-icon' src={'/images/breadright.svg'} /></li>
...
<div class="modal fade OutPymentSpecific" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div className="col-lg-4 p-4">
                 ...
                 <div className="payment-details">
                     <ul>
                           ...
                           <li>
                              <h4>Return shipping fee</h4>
                                 <p>31 Jan, 24 (-₹76)</p>
                           </li>
                           <li>
                              <h4>Recovery Pending</h4>
                                 <p>31 Jan, 24 (-₹76)</p>
                           </li>
                     </ul>
                 </div>
...
export default OutPymentSpecific;