...
export const ViewProfileSupplier = () => {
    ...
    console.log(data);
      ...
      useEffect(() => {
        axios.post(`${baseUrl}/Supplier/Get_Supplier_Details`, {supplier_id: id,
        })
        .then((res) => {
                ...
                <div className="container-fluid form-border-bg p-md-5">
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 mb-4">
                            ...
                            <span class="lablename"> {data?.account_number}</span>
                        </div>
                    </div>
                    <div className="btn-groupnewstyle mt-5">
                        <NavLink className="formbtnnew2" to={"/supplier/update-profile"}> Update Profile</NavLink>
